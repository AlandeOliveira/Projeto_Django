...
from .teste_recipe_base import RecipeTestBase, models
...
class RecipeModelTest(RecipeTestBase):
    ...
    def test_recipe_string_representation(self):
        needed_string = 'Testing Representation'
        self.recipe.title = 'Testing Representation'
        self.recipe.full_clean()
        self.recipe.save()
        self.assertEqual(str(self.recipe), needed_string, msg=f'Recipe string representation must be ' \
                         f'"{needed_string}" but "{str(self.recipe)}" was received.')
